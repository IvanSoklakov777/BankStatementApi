...
namespace BankStatementApi.Migrations
{
    ...
    [Migration("20220629091443_InitializationBankStatementService")]
    partial class InitializationBankStatementService
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankStatementApi.DAL.EF.BankAccountDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("BankStatementApi.DAL.EF.PaymentOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BankStatementApi.DAL.Entities.DataStorage", b =>
                {
                    ...
                    b.Property<int>("ImportDataLogId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ImportDataLogId")
                        .IsUnique();

                    b.ToTable("DataStorage");
                });

            modelBuilder.Entity("BankStatementApi.DAL.Entities.HistoryOperationType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("HistoryOperationType");
                });
            ...
            modelBuilder.Entity("BankStatementApi.DAL.EF.BankAccountDocument", b =>
                {
                    b.HasOne("BankStatementApi.DAL.Entities.DataLog", "Import")
            ...
            modelBuilder.Entity("BankStatementApi.DAL.EF.PaymentOrder", b =>
                {
                    b.HasOne("BankStatementApi.DAL.EF.BankAccountDocument", "BankAccountDocument")
            ...
            modelBuilder.Entity("BankStatementApi.DAL.Entities.DataStorage", b =>
                {
                    b.HasOne("BankStatementApi.DAL.Entities.DataLog", "ImportDataLog")
                        .WithOne("ImportDataStorage")
                        .HasForeignKey("BankStatementApi.DAL.Entities.DataStorage", "ImportDataLogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ImportDataLog");
                });
            ...
            modelBuilder.Entity("BankStatementApi.DAL.Entities.HistoryOperationType", b =>
                {
                    ...
                    b.HasOne("BankStatementApi.DAL.EF.PaymentOrder", "PaymentOrder")
                        .WithMany("History")
            ...
            modelBuilder.Entity("BankStatementApi.DAL.Entities.DataLog", b =>
                {
                    ...
                    b.Navigation("ImportDataStorage");
                });
